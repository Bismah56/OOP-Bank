...
class customerInfo {
    ...
    CNIC;
    Balance;
    Pin_Code; //which user will decide & input while creating his/her account
    Account_Title;
    IBAN;
    constructor(first, last, age, gender, mobileNo, cnic, bal, PIN) {
...
class myBank {
    ...
    CreateAccount(first, last, age, gender, mobileNo, cnic, bal, PIN) {
